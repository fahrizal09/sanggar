            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="formAchiev" method="post" action="<?= base_url('backoffice/trainer/update/' . $data->id_trainer) ?>" enctype="multipart/form-data">
                            <div class="card-body row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="name_trainer" class="form-control" id="exampleInputPassword1" placeholder="Password" value="<?= $data->name_trainer ?>">
                                </div>
                            </div>
                            <!-- /.card-body -->
